...
vertex main0_out main0(main0_in in [[stage_in]], constant float4x4& g_ModelViewProjectionMatrix [[buffer(0)]], constant float2& g_Scale [[buffer(1)]], constant float4& g_Texture2Resolution [[buffer(2)]], constant float& g_Strength [[buffer(3)]])
{
    main0_out out = {};
    ...
    float2 _75 = float2((_55 * g_Texture2Resolution.z) / g_Texture2Resolution.x, (_67 * g_Texture2Resolution.w) / g_Texture2Resolution.y);
