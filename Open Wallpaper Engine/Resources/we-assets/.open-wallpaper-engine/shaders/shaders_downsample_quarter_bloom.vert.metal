...
vertex main0_out main0(main0_in in [[stage_in]], constant float2& g_TexelSize [[buffer(0)]])
{
    ...
    v_TexCoord[0] = in.a_TexCoord - g_TexelSize;
    v_TexCoord[1] = in.a_TexCoord + g_TexelSize;
    v_TexCoord[2] = in.a_TexCoord + float2(-g_TexelSize.x, g_TexelSize.y);
    v_TexCoord[3] = in.a_TexCoord + float2(g_TexelSize.x, -g_TexelSize.y);
