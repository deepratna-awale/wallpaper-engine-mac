...
fragment main0_out main0(main0_in in [[stage_in]], constant float& g_Multiply [[buffer(0)]], texture2d<float> g_Texture0 [[texture(0)]], texture2d<float> g_Texture1 [[texture(1)]], texture2d<float> g_Texture2 [[texture(2)]], sampler g_Texture0Smplr [[sampler(0)]], sampler g_Texture1Smplr [[sampler(1)]], sampler g_Texture2Smplr [[sampler(2)]])
{
    main0_out out = {};
    ...
    float param_3 = blend;
    float3 _123 = ApplyBlending(param, param_1, param_2, param_3);
    albedo.x = _123.x;
    albedo.y = _123.y;
    albedo.z = _123.z;
