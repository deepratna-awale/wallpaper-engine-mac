...
def implemented():
    ...
    renderer = open(os.path.join(REPO, "OpenWallpaperEngine/Scene/Rendering/SceneMetalRenderer.swift"),
                    encoding="utf-8").read()
    engine = open(os.path.join(REPO, "OpenWallpaperEngine/Scene/Scripting/AudioReactiveScriptEngine.swift"),
                  encoding="utf-8").read()
