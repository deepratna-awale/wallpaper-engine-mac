...
vertex main0_out main0(main0_in in [[stage_in]], constant float2& g_TexelSize [[buffer(0)]])
{
    ...
    v_TexCoord[0] = float2(in.a_TexCoord.x, in.a_TexCoord.y - (localTexel * 6.0));
    v_TexCoord[1] = float2(in.a_TexCoord.x, in.a_TexCoord.y - (localTexel * 5.0));
    v_TexCoord[2] = float2(in.a_TexCoord.x, in.a_TexCoord.y - (localTexel * 4.0));
    v_TexCoord[3] = float2(in.a_TexCoord.x, in.a_TexCoord.y - (localTexel * 3.0));
    v_TexCoord[4] = float2(in.a_TexCoord.x, in.a_TexCoord.y - (localTexel * 2.0));
    v_TexCoord[5] = float2(in.a_TexCoord.x, in.a_TexCoord.y - localTexel);
    v_TexCoord[6] = float2(in.a_TexCoord.x, in.a_TexCoord.y);
    v_TexCoord[7] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 1.0));
    v_TexCoord[8] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 2.0));
    v_TexCoord[9] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 3.0));
    v_TexCoord[10] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 4.0));
    v_TexCoord[11] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 5.0));
    v_TexCoord[12] = float2(in.a_TexCoord.x, in.a_TexCoord.y + (localTexel * 6.0));
