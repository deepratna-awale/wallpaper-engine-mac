...
vertex main0_out main0(main0_in in [[stage_in]], constant float4x4& g_ModelViewProjectionMatrix [[buffer(0)]], constant float4& g_Texture1Resolution [[buffer(1)]], constant float2& g_Bounds [[buffer(2)]])
{
    main0_out out = {};
    ...
    out.v_Bounds.x = g_Bounds.x;
    out.v_Bounds.y = 1.0 / (g_Bounds.y - g_Bounds.x);
    return out;
}
