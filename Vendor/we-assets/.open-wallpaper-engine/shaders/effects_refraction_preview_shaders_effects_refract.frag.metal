...
fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> g_Texture2 [[texture(0)]], texture2d<float> g_Texture0 [[texture(1)]], sampler g_Texture2Smplr [[sampler(0)]], sampler g_Texture0Smplr [[sampler(1)]])
{
    main0_out out = {};
    float mask = 1.0;
    float2 texCoord = in.v_TexCoord.xy;
    float4 param = g_Texture2.sample(g_Texture2Smplr, in.v_RefracttTexCoord.xy);
